...
<body>
    <div class="contenedor">
        <header class="cabecera" id="nav">
            ...
            <ul>
                <li><a class="elemento_menu activo" href="#sobre_mi">SOBRE MÍ</a></li>
        ...
        <div class="flecha_subir">
            <a href="#sobre_mi" title="Ir arriba"><i class="fas fa-arrow-alt-circle-up"></i></a>
        </div>
    </div>
</body>
</html>